class Smiley extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("Peace", "hand_yellow_peace.png");
    ...
    create() {
        ...
        my.sprite.rightPeace = this.add.sprite(this.rightHandX, this.rightHandY, "Peace");
        ...
        my.sprite.rightPeace.visible = false;
    }
        ...
        if (this.counter % 120 == 0) {  // Do this once every 120 calls to update()
            switch (this.smileType) {
                case "Smile":
                    ...
                    my.sprite.rightPeace.visible = true;
                    break;
                case "Dimple":
